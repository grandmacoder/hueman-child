...
if ( is_user_logged_in() ) {
    ...
    foreach ($roles as $role){
	 if ($role =='subscriber' || $role =='bbp_participant'  ) { $bCreateTopics =0;}
	 }

	 }
*/
?>
<?php //if ( bbp_current_user_can_access_create_topic_form() && $bCreateTopics == 1 ) : ?>
				...
				<legend>
                    ...
                    $forum_title=str_replace('Private:','',$forum_title);
						if ( bbp_is_topic_edit() )
							printf( __( 'Now Editing &ldquo;%s&rdquo;', 'bbpress' ), $forum_title );
						else
							bbp_is_single_forum() ? printf( __( 'Create New Topic in &ldquo;%s&rdquo;', 'bbpress' ), $forum_title ) : _e( 'Create New Topic', 'bbpress' );
					?>
