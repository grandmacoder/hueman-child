...
/*flip nav */	
 ...
 $('a.openwin').click(function() {
	      window.open(this.href, '_blank','left=10,top=10,width=900,height=600,toolbar=1,resizable=1');
		  return false;
...
/*
-------------------
Student progress on modules pop up a summary sheet
-------------------
*/
...
/*
-------------------
Handle summary sheet click button
-------------------
*/
